...
import { setPosts, onAfterSuccessSendPost } from './update-posts.js';

initDrawPictures(openBigPictureModal);
initBigPictureModal();
initNewPostModal(onAfterSuccessSendPost);
 ...
 * + 2. При просмотре поста можно оставить коментарий, добавляеться на первое место и сразу отображается
 ...
 * + 6. После публикации поста, он добавляеться на главную страницу, но без применения фильтро, можно попробовать применить File API или что то другое
 *
